...
sec1 = """
      ...
      <section style="margin-top: 2.5rem;">
        ...
        <p>
          Tailgating happens across NASCAR, but Bristol's culture is celebrated as the best in motorsport. Thunder Valley sits carved directly into an Appalachian mountain bowl, concentrating cheers, revving engines, and hardwood smoke across the ridges.
        </p>
        <p>
          Bristol fans do not simply tailgate for an hour before the race; they celebrate all weekend long from Thursday through Sunday. Rivalries are intense on the high banks, but the moment you step foot in the campground, mountain hospitality rules.
        </p>
        <div class="quote-box">
          &ldquo;Walk down any row of campers at Bristol and you are family. Fans share cold drinks, trade barbecue samples, and invite you to pull up a camp chair by the fire.&rdquo;
        </div>
        <p>
          Tailgate vibes adapt to each race weekend. The springtime <a href="../food-city-500.html"><strong>Food City 500</strong></a> brings sunny afternoon cookouts beneath blooming dogwood trees, while September's <a href="../bass-pro-night-race.html"><strong>Bass Pro Shops Night Race</strong></a> serves as an electric, high-stakes playoff cutoff where smokers run until sunrise.
        </p>
      </section>
"""
...
sec2 = """
      ...
      <section style="margin-top: 2.5rem;">
        ...
        <p>
          Great race day barbecue requires choosing the right cooker for campground life:
        </p>
        ...
        <div class="gear-grid">
          <div class="gear-card">
            ...
            <ul>
              <li>Thermostat holds 225°F for 12 hours with steady hardwood smoke.</li>
              <li>Requires 110V power; full hookup RV sites make this effortless.</li>
              <li>Store wood pellets in moisture-proof containers.</li>
            </ul>
          </div>

          <div class="gear-card">
            <h4>🪵 Charcoal Grills &amp; Smokers (Weber, WSM)</h4>
            <p><strong>Best For:</strong> Deep smoke rings and authentic wood bark.</p>
            <ul>
              <li>Unbeatable wood-fired flavor with zero electrical needs.</li>
              <li>Requires active damper management and careful ash clean-up.</li>
              <li>Always bring a metal bucket for safely extinguishing spent coals.</li>
            </ul>
          </div>

          <div class="gear-card">
            <h4>🍳 Portable Propane Griddles (Blackstone 22")</h4>
            <p><strong>Best For:</strong> Quick morning meals and fast pre-race cookouts.</p>
            <ul>
              <li>Instant heat with no ash; perfect for smashburgers and breakfast hash.</li>
              <li>Lacks wood smoke for low-and-slow cuts.</li>
              <li>Use a conversion hose to hook up standard 20-lb propane tanks.</li>
            </ul>
          </div>
        </div>
        ...
        <div class="callout-box">
          ...
          <p style="margin-bottom: 0;">
            Set cookers on level ground at least 10 feet from camper awnings and tents. Ridge winds can carry sparks, so never leave coals unattended and keep an ABC extinguisher or water bucket close at hand.
          </p>
        </div>
      </section>
"""
...
sec3 = """
      ...
      <section style="margin-top: 2.5rem;">
        ...
        <p>
          These five crowd-pleasing recipes are engineered specifically for smooth campsite cooking:
        </p>
        ...
        <div class="recipe-card">
          ...
          <p>
            Pork butt is the quintessential race meat: forgiving, feeds a crew, and rests perfectly in a cooler. Rub an 8-lb pork shoulder with yellow mustard and brown-sugar rub. Smoke over hickory at 225°F for 5 hours. Spritz with apple cider vinegar, wrap in foil with butter and brown sugar, and cook at 250°F until probe-tender (203°F). Rest in an insulated cooler for 2 hours before pulling onto brioche buns with slaw.
          </p>
        </div>
        ...
        <div class="recipe-card">
          ...
          <p>
            Season 2 racks of St. Louis-cut ribs with pork rub. Smoke meat-side up at 225°F with applewood for 3 hours. Wrap tightly in heavy foil with butter, brown sugar, and honey for 2 hours to tenderize. Unwrap, brush with sweet barbecue sauce, and cook 1 final hour until the glaze bubbles into a glossy lacquer. Slice and serve hot.
          </p>
        </div>
        ...
        <div class="recipe-card">
          ...
          <p>
            Season a trimmed USDA Prime brisket with equal parts coarse salt and black pepper. Smoke overnight at 225°F over oak or hickory. Wrap in butcher paper at 165°F and continue cooking until probe-tender (202°F). Rest 2 to 3 hours in a dry cooler, then slice thin and serve on sweet Hawaiian rolls with tangy slaw and pickled jalapeños.
          </p>
        </div>
        ...
        <div class="recipe-card">
          ...
          <p>
            Toss dried wings with baking powder and poultry rub for crispy skin with wood smoke. Smoke at 250°F for 45 minutes, then finish at 400°F for 30 minutes until blistered and golden. Toss half in spicy Buffalo sauce and dunk the rest in creamy Alabama white barbecue sauce (mayo, cider vinegar, pepper, horseradish).
          </p>
        </div>
        ...
        <div class="recipe-card">
          ...
          <p>
            An Appalachian classic featuring crispy edges and a peppery, sweet crumb. Preheat a 10-inch cast iron skillet with bacon grease on your grill. Whisk 2 cups cornmeal mix, buttermilk, eggs, melted butter, honey, cheddar cheese, and diced jalapeño. Pour into the hot skillet and bake indirectly at 375°F for 30 minutes. Brush with warm honey butter before serving.
          </p>
        </div>
      </section>
"""
      ...
      <section style="margin-top: 2.5rem;">
        ...
        <div class="gear-grid">
          <div class="gear-card">
            ...
            <ul>
              <li><strong>Meat Cooler:</strong> Heavy-duty cooler with block ice dedicated to raw meat.</li>
              <li><strong>Drink Cooler:</strong> Separate cooler for beers, soda, and water with cubed ice.</li>
              <li><strong>Resting Cooler:</strong> Insulated cooler lined with towels to hold smoked barbecue warm.</li>
              <li><strong>Foil &amp; Tongs:</strong> 18-inch heavy foil and long metal tongs for hot grates.</li>
            </ul>
          </div>
          ...
          <div class="gear-card">
            ...
            <ul>
              <li><strong>Pop-Up Canopy:</strong> 10x10 heavy-gauge frame for sun and rain shelter.</li>
              <li><strong>Leg Weights:</strong> Secure canopy legs against sudden mountain ridge gusts.</li>
              <li><strong>Camp Chairs:</strong> Folding chairs with built-in cup holders and lumbar support.</li>
              <li><strong>Ground Mat:</strong> Breathable patio mat keeps dirt outside your camper door.</li>
            </ul>
          </div>
          ...
          <div class="gear-card">
            ...
            <ul>
              <li><strong>Cornhole Boards:</strong> Regulation boards and bean bags for campsite tournaments.</li>
              <li><strong>Bluetooth Speaker:</strong> Weatherproof speaker for prerace tunes and radio feeds.</li>
              <li><strong>Tailgate TV:</strong> Outdoor monitor for practice and qualifying broadcasts.</li>
              <li><strong>String Lights:</strong> LED campsite lighting for safe evening grilling.</li>
            </ul>
          </div>

          <div class="gear-card">
            <h4>🧼 Prep Tools &amp; Clean-Up</h4>
            <ul>
              <li><strong>Digital Meat Probe:</strong> Instant-read thermometer for internal temperatures.</li>
              <li><strong>Insulated Gloves:</strong> Heat-safe food gloves for pulling hot pork and brisket.</li>
              <li><strong>Wash Station:</strong> Water jug with spigot, pump soap, and paper towels.</li>
              <li><strong>Contractor Bags:</strong> Heavy trash bags to keep your campsite spotless.</li>
            </ul>
          </div>
        </div>
      </section>
      ...
      <section style="margin-top: 2.5rem;">
        ...
        <div class="timeline-block">
          ...
          <div class="timeline-body">
            <h4>Arrival, Basecamp Setup &amp; Truck Race</h4>
            <p>
              Check in, level your camper, connect hookups, and roll out your awning. Grill quick burgers or brats on the flat-top, then enjoy the Thursday night UNOH 200 Truck Series race.
            </p>
          </div>
        </div>
        ...
        <div class="timeline-block">
          ...
          <div class="timeline-body">
            ...
            <p>
              Cook bacon and eggs on the griddle. Trim fat from briskets and pork butts, apply rubs, and keep meats chilled so flavors cure deep into the muscle.
            </p>
          </div>
        </div>
        ...
        <div class="timeline-block">
          ...
          <div class="timeline-body">
            <h4>Wing Cookout &amp; Overnight Pit Lighting</h4>
            <p>
              Smoke crispy chicken wings for happy hour and watch the Xfinity Series race. Before bed around 10:30 PM, light your smoker and put on pork butts or brisket for an overnight cook.
            </p>
          </div>
        </div>
        ...
        <div class="timeline-block">
          ...
          <div class="timeline-body">
            ...
            <p>
              Check temperatures. Wrap brisket or pork in butcher paper once the bark sets (~165°F). Load your St. Louis ribs onto the smoker for their 3-2-1 cook.
            </p>
          </div>
        </div>
        ...
        <div class="timeline-block">
          ...
          <div class="timeline-body">
            ...
            <p>
              Place probe-tender meats into an insulated towel-lined cooler to rest. Glaze the ribs and bake skillet jalapeño cornbread on the grill.
            </p>
          </div>
        </div>
        ...
        <div class="timeline-block">
          ...
          <div class="timeline-body">
            ...
            <p>
              Shred pork, slice brisket, and feast with friends. Pack your clear bags and track-approved soft coolers, then take the easy 15-minute walk down to BMS.
            </p>
          </div>
        </div>
        ...
        <div class="timeline-block">
          ...
          <div class="timeline-body">
            ...
            <p>
              Stroll back up to camp while highway traffic idles in gridlock. Stoke the campfire, toast s'mores, and reheat sliders while rehashing the race under the stars.
            </p>
          </div>
        </div>
      </section>
...
sec6 = """
      ...
      <section style="margin-top: 2.5rem;">
        ...
        <ul>
          <li><strong>Panoramic Hilltop Elevation:</strong> Perched on a high ridge at 133 Hilltop Street, our grounds offer scenic mountain views and BMS stadium sightlines, with refreshing breezes that clear smoker exhaust.</li>
          <li><strong>Generous Lot Spacing:</strong> Ample room to extend full RV awnings, erect 10x10 canopies, arrange circle seating, and set up regulation cornhole courts without crowding your neighbor.</li>
          <li><strong>Full Hookup Convenience:</strong> Municipal fresh water, sewer hookups, and reliable 30-amp and 50-amp power for pellet smokers, refrigerators, blenders, and outdoor TVs.</li>
          <li><strong>Easy 0.9-Mile Walk to BMS:</strong> Just 0.9 miles from the main gate, campers enjoy an easy 15-minute walk—avoiding steep parking fees and 2-to-3-hour post-race highway gridlocks.</li>
        </ul>
      </section>
"""
...
sec7 = """
      ...
      <section style="margin-top: 2.5rem;">
        ...
        <p>
          Bristol Motor Speedway allows fans to bring food and beverages into the grandstands, subject to strict gate security rules:
        </p>
        ...
        <div class="callout-box callout-box--accent">
          ...
          <p style="margin-bottom: 0;">
            Freeze four water bottles solid before race day to line the bottom of your 14x14 soft cooler instead of loose ice. They keep food and beer cold without soggy waterlogging and provide ice-cold drinking water as they thaw.
          </p>
        </div>
      </section>
"""
...
sec9 = """
      ...
      <section style="margin-top: 2.5rem;">
        ...
        <p>
          Campground potlucks develop naturally across our ridge. On Friday and Saturday afternoons, neighbors align camp tables into an Appalachian feast: one group shares smoked wings, another offers cast-iron cobbler, and others bring pimento cheese dip and beans.
        </p>
        <div class="callout-box">
        ...
        <div class="faq__list" style="margin-top: 1.5rem;">
          ...
          <div class="faq__item">
            ...
            <div class="faq__answer">
              <p>
                Yes! Bristol Hilltop Camping welcomes smokers, charcoal grills, pellet cookers, and propane flat-tops. Grills must sit on stable ground away from awnings and dry grass. Cool all embers before disposing in designated metal cans.
              </p>
            </div>
          </div>
...
print("Total words in calibrated article:", len(words))
